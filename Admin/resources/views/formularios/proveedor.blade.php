...
<div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
    ...
    <form action="{{ route('proveedores.guardar') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="direccion" name="direccion" class="mt-1 block w-full p-2 border border-gray-300 rounded-md" required>
        </div>

        <div class="mb-4">
            <label for="telefono" class="block text-sm font-medium text-gray-700">Teléfono</label>
            <input type="text" id="telefono" name="telefono" class="mt-1 block w-full p-2 border border-gray-300 rounded-md" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" id="nombre_contacto" name="nombre_contacto" class="mt-1 block w-full p-2 border border-gray-300 rounded-md" required>
        </div>

        <div class="mb-4">
            <label for="contacto" class="block text-sm font-medium text-gray-700">Contacto</label>
            <input type="text" id="contacto" name="contacto" class="mt-1 block w-full p-2 border border-gray-300 rounded-md" required>
        </div>

        <div class="mb-4">
            <label for="estado" class="block text-sm font-medium text-gray-700">Estado</label>
            <input type="text" id="estado" name="estado" class="mt-1 block w-full p-2 border border-gray-300 rounded-md" required>
        </div>

        <div class="mb-4">
            <button type="submit" class="text-white bg-blue-500 px-4 py-2 rounded">Registrar Proveedor</button>
        </div>
    </form>
